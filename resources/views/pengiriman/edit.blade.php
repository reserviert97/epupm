...
@section('title', 'Edit #'. $pengiriman->no_kirim)
...
<div class="container">
    ...
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('jual.update', $pengiriman->id) }}" method="post">
            @csrf
            @method('put')
            <div class="card-header">
                <h3 class="card-title">Pengiriman Beras</h3>
                <div class="card-options">
                    <a href="{{ route('jual.index') }}" class="btn btn-secondary btn-sm"><i class="fe fe-arrow-left mr-1"></i>Kembali</a>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $pengiriman->no_kirim }}" disabled>
                            <input type="hidden" value="{{ $pengiriman->no_kirim }}" name="no_kirim">
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select" name="toko">
                                @foreach ($toko as $item)
                                    <option value="{{ $item->id }}" {{ $pengiriman->toko_id == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="volume" aria-describedby="basic-addon2" value="{{ $pengiriman->volume }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control text-right" name="harga" value="{{ $pengiriman->harga }}">
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control text-right" value="{{ number_format($pengiriman->total) }}" disabled>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer text-right">
                <form action="{{ route('jual.destroy', $pengiriman->id ) }}" method="post">
                    @csrf @method('delete')
