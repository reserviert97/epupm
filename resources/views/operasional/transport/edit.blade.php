...
@section('title', 'Edit #'.$data->no_transport)
...
<div class="container">
    ...
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('transport.update', $data->id) }}" method="post">
            @csrf
            @method('put')
            
            <div class="card-header">
                <h3 class="card-title">Ubah Transaksi Transport</h3>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $data->no_transport }}" disabled>
                            <input type="hidden" value="{{ $data->no_transport }}" name="no">
                        </div>
            ...
            <div class="card-footer text-right">
                <form action="{{ route('transport.destroy', $data->id ) }}" method="post">
                    @csrf @method('delete')
