...
<div class="container">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('giling.store') }}" method="post">
            @csrf
            
            <div class="card-header">
                <h3 class="card-title">Penggilingan</h3>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" value="{{ $inv }}" name="no_giling">
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="volume_gkg" aria-describedby="basic-addon2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" name="volume_beras" aria-describedby="basic-addon2">
                                <span class="input-group-append" id="basic-addon2">
                                    <span class="input-group-text">Kg</span>
                                </span>
                            </div>
