...
@section('title', 'Edit #'.$data->no_giling)
...
<div class="container">
    ...
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('giling.update', $data->id) }}" method="post">
            @csrf
            @method('put')
            
            <div class="card-header">
                <h3 class="card-title">Ubah Penggilingan</h3>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $data->no_giling }}" disabled>
                            <input type="hidden" value="{{ $data->no_giling }}" name="no">
                        </div>
                        ...
                        <div class="form-group">
                            <label class="form-label">Rendemen</label>
                            <div class="input-group">
                                <input type="number" class="form-control text-right" aria-describedby="basic-addon2" value="{{ round($data->rendemen, 2) }}" disabled>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            <label class="form-label">Volume Gabah</label>
                            <div class="input-group">
                                <input type="number" class="form-control text-right" name="volume_gkg" aria-describedby="basic-addon2" value="{{ $data->volume_gkg }}">
                                <span class="input-group-append" id="basic-addon2">
                        ...
                        <div class="form-group">
                            <label class="form-label">Volume Beras</label>
                            <div class="input-group">
                                <input type="number" class="form-control text-right" name="volume_beras" aria-describedby="basic-addon2" value="{{ $data->volume_beras }}">
                                <span class="input-group-append" id="basic-addon2">
                                    <span class="input-group-text">Kg</span>
                                </span>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control text-right" value="350" disabled>
                                <span class="input-group-append" id="basic-addon2">
            ...
            <div class="card-footer text-right">
                <form action="{{ route('giling.destroy', $data->id ) }}" method="post">
                    @csrf @method('delete')
