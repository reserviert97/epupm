...
@section('title', 'Buat Transkasi')

@section('content')
<div class="container">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('plastik.store') }}" method="post">
            @csrf
            
            <div class="card-header">
                <h3 class="card-title">Pembelian Plastik</h3>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" value="{{ $inv }}" name="no_plastik">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-switches-stacked">
                                <label class="custom-switch">
                                    <input type="radio" name="jenis" value="Waring 50 Kg" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Waring 50 Kg</span>
                                </label>
                                <label class="custom-switch">
                                    <input type="radio" name="jenis" value="Plastik 5 Kg" class="custom-switch-input" checked>
                                    <span class="custom-switch-indicator"></span>
