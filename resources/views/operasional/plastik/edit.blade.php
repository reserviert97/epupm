...
@section('title', 'Edit #'.$data->no_plastik)
...
<div class="container">
    ...
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('plastik.update', $data->id) }}" method="post">
            @csrf
            @method('put')
            
            <div class="card-header">
                <h3 class="card-title">Ubah Pembelian Plastik</h3>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $data->no_plastik }}" disabled>
                            <input type="hidden" value="{{ $data->no_plastik }}" name="no">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-switches-stacked">
                                <label class="custom-switch">
                                    <input type="radio" name="jenis" value="Waring 50 Kg" class="custom-switch-input" {{ $data->jenis == 'Waring 50 Kg' ? 'checked' : '' }}>
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Waring 50 Kg</span>
                                </label>
                                <label class="custom-switch">
                                    <input type="radio" name="jenis" value="Plastik 5 Kg" class="custom-switch-input" {{ $data->jenis == 'Plastik 5 Kg' ? 'checked' : '' }}>
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description">Plastik 5 Kg</span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control text-right" value="{{ $data->harga }}" name="harga">
                                <span class="input-group-append" id="basic-addon2">
                                    <span class="input-group-text"><i class="fe fe-at-sign mr-1"></i> Buah</span>
                                </span>
                            </div>
                        </div>
            ...
            <div class="card-footer text-right">
                <form action="{{ route('plastik.destroy', $data->id ) }}" method="post">
                    @csrf @method('delete')
